...
const obj = {
    ...
    NAME: 'SunbirdServiceHealthCheck',
    API_VERSION: '1.0'
}
...
let health_check = async function(req,res) {
    ...
    let elasticSeacrhConnection = await elasticSearch.health_check();
    checks.push(checkResult("MONGO_DB",mongodbConnection));
    checks.push(checkResult("KENDRA_SERVICE",kendraServiceStatus));
    checks.push(checkResult("ELASTIC_SEARCH",elasticSeacrhConnection));
